...
import 'com/uci/api/about_api.dart';
import 'com/uci/api/moves_api.dart';
...
class Openapi {
  ...
  /// Get AboutApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  AboutApi getAboutApi() {
    return AboutApi(dio, serializers);
  }
